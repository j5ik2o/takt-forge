...
4. Analyze the task description and extract functional and non-functional requirements
5. Create EARS-format acceptance criteria for each requirement
6. Cover normal cases, error cases, and boundary conditions
7. Identify dependencies between requirements
8. Save the artifact to `.kiro/specs/{feature}/requirements.md`
